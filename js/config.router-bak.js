  ...
  .config(
    [          '$stateProvider', '$urlRouterProvider',
      function ($stateProvider,   $urlRouterProvider) {
          ...
          // 最先显示的首页，app/说明它首先要调用app
          var first = "/h5/cource";
          $urlRouterProvider.otherwise(first);
          //$urlRouterProvider.otherwise('/app/dashboard-v1'); // 菜单路由值 地址中转入时调用
          ...
          $stateProvider
              ...
              .state("h5.cource", {
                  url : "/cource",
                  templateUrl : "tpl/study/cource/cource.html",
                  resolve : {
                      deps: [ "uiLoad", "$ocLazyLoad",
                          function(uiLoad, $ocLazyLoad) {
                              var loadedJsModule = [
              ...
              .state("h5.study", {
                  url : "/study",
                  templateUrl : "tpl/study/study/study.html",
                  resolve : {
                      deps: [ "uiLoad", "$ocLazyLoad",
                          function(uiLoad, $ocLazyLoad) {
                              var loadedJsModule = [
              ...
              .state("h5.test", {
                  url : "/test",
                  templateUrl : "tpl/study/test/courceTest.html",
                  resolve : {
                      deps: [ "uiLoad", "$ocLazyLoad",
                          function(uiLoad, $ocLazyLoad) {
                              var loadedJsModule = [
              ...
              .state("h5.confirm", {
                  url : "/confirm",
                  templateUrl : "tpl/study/confirm/confirm.html",
                  resolve : {
                      deps: [ "uiLoad", "$ocLazyLoad",
                          function(uiLoad, $ocLazyLoad) {
                              var loadedJsModule = [
              ...
              // 以下是基于PC端的，现仅供参考，后续清除
              .state('app', {
                  abstract: true,
                  url: '/app',
                  templateUrl: 'tpl/app.html'  // 模板地址
              })

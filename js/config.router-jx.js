    ...
    .config(
        ['$stateProvider', '$urlRouterProvider',
            function($stateProvider, $urlRouterProvider) {
                ...
                .state("h5.auth", {
                    url: "/auth",
                    templateUrl: "tpl/study/login/loginAuth.html",
                    resolve: {
                        deps: ["uiLoad", "$ocLazyLoad",
                            function(uiLoad, $ocLazyLoad) {
                                var loadedJsModule = [
                                    "js/study/login/loginService.js",
                                    "js/study/login/authController.js"
                                ];
                                return $ocLazyLoad.load(loadedJsModule);
                            }
                        ]
                ...
                // 5. 人脸识别 [http://ip:port/jpv2H2/index.html#/h5/photograph]
                    ...
                    .state("h5.login", {
                        url: "/login",
                        templateUrl: "tpl/study/login/jxlogin.html",
                        resolve: {
                            deps: ["uiLoad", "$ocLazyLoad",
                                function(uiLoad, $ocLazyLoad) {
                                    var loadedJsModule = [
                                        "css/public.css",
                                        "js/study/login/jxloginController.js",
                                        "js/study/login/loginService.js"
                                    ];
                                    return $ocLazyLoad.load(loadedJsModule);
                                }
                    ...
                    .state("h5.survery",{
                    	url:'/survery',
                    	templateUrl:"tpl/study/survery/survery.html",
                    	resolve: {
	                        deps: ["uiLoad", "$ocLazyLoad",
	                            function(uiLoad, $ocLazyLoad) {
	                                var loadedJsModule = [
	                                    "css/public.css",
	                                    "js/study/survery/surveryController.js"
	                                ];
	                                return $ocLazyLoad.load(loadedJsModule);
	                            }
	                        ]
